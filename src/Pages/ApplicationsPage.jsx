// src/components/ApplicationsPage.js
  ...
  return (
    <div className="mx-5 md:mx-40 lg:mx-60">
      ...
      <div className="my-5">
        ...
        <b>
          <div>
            While All reasonable efforts shall be made to ensure that the information contained on this website is updated, accurate and complete. However, no representations or warranties are made (express or implied) as to the reliability, accuracy or completeness of such information. And The Service provider/ Website provider has hosted the website for the firm holding the Website , And in no event shall the Service provider/ Website provider be liable for the content provided on website. Thus, the Firm holding the Website and/or the end user shall refer to the Government and/or Original sources which had published/provided such content or information.
          </div>
        </b>
        <br />
      </div>
